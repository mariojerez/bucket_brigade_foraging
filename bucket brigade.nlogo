patches-own [
  ...
  food-source?   ;; number (1, 2, or 3) to identify the food sources
]
turtles-own [remaining-steps]
...
to setup-food  ;; patch procedure
  set food-source? (distancexy -30 30) < 5
  if food-source?
  [set food one-of [1 2]]
...
to return-to-nest  ;; turtle procedure
  ...
  [ ;; drop food and head out again
    set color red
    rt 180 ]
  [ ifelse remaining-steps > 0
    [ set chemical chemical + 60  ;; drop some chemical
      uphill-nest-scent
      set remaining-steps remaining-steps - 1 ]         ;; head toward the greatest value of nest-scent
    [ set food 1
      set pcolor blue
      set color red
      rt 180]]
...
When an ant finds a piece of food, it carries the food ten steps in the direction of the nest before dropping it and turning back to the food source, dropping a chemical as it moves. When other ants "sniff" the chemical, they follow the chemical toward the food. As more ants carry food to the nest, they reinforce the chemical trail.
